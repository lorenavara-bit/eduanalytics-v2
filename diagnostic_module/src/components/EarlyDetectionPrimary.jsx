        ...
        return (
            <div className="bg-white rounded-3xl shadow-xl overflow-hidden border border-gray-100 max-w-2xl mx-auto">
                <div className="p-8 text-center bg-gradient-to-br from-indigo-600 to-blue-700 text-white">
                    ...
                    <h2 className="text-3xl font-bold mb-4">Centro de Alerta Temprana</h2>
                    <p className="text-blue-100 opacity-90 leading-relaxed">
                        Este cuestionario para padres ayuda a identificar patrones de aprendizaje que podrían requerir atención especializada (Dislexia, TDAH o Altas Capacidades).
                    </p>
                </div>
                <div className="p-10 space-y-6">
                    <div className="flex gap-4 items-start p-4 bg-yellow-50 border border-yellow-200 rounded-xl">
                        ...
                        <p className="text-sm text-yellow-800">
                            <strong>Nota Importante:</strong> Esto no es un diagnóstico médico. Es una herramienta de cribado para orientar a padres y educadores.
                        </p>
                    </div>
                    ...
                    <div className="flex flex-col gap-3">
                        ...
                        <button
                            ...
                            className="w-full py-4 bg-white text-indigo-600 border-2 border-indigo-100 font-bold rounded-2xl hover:bg-indigo-50 transition-all flex items-center justify-center gap-2 group"
                        >
                            <Gamepad2 className="w-5 h-5 text-indigo-500" />
                            Ir directamente a las Misiones de Juego
                        </button>
                    </div>
                </div>
            </div>
                ...
                {loading ? (
                    ...
                    <div className="space-y-8">
                        ...
                        <div className="bg-indigo-900 rounded-3xl p-8 text-white relative overflow-hidden">
                            <Waves className="absolute bottom-0 right-0 text-white/10 w-40 h-40 -mb-10 -mr-10 rotate-12" />
                            <div className="relative z-10 flex flex-col md:flex-row items-center gap-6">
                                <div className="text-center md:text-left flex-grow">
                                    <h4 className="text-xl font-bold mb-2">Refuerza el análisis con juegos</h4>
                                    <p className="text-indigo-200 text-sm leading-relaxed max-w-md">
                                        Pide a tu hijo/a que complete las "Misiones de Explorador". Los datos de juego nos darán una visión más precisa.
                                    </p>
                                </div>
                                <button
                                    onClick={() => onComplete('GAMES')}
                                    className="px-8 py-3 bg-white text-indigo-900 font-bold rounded-2xl hover:bg-blue-50 transition-all flex items-center gap-2 shrink-0 shadow-lg"
                                >
